...
filename_log = 'Results-'+datas+contrst+cfg['model_params']['encoder']+"-"+"batch"+str(bs)+pl+'.txt'
...
print(len(training_generator)*cfg['dataset_params']['batch_size'] , len(training_generator)*cfg['dataset_params']['batch_size'])
...
# bs=cfg['dataset_params']['batch_size']
# now = datetime.datetime.now()
# filename_log = 'Results-'+"-with_contrst-"+cfg['model_params']['encoder']+"-"+"batch"+str(bs)+"-"+str(now)+'.txt'
