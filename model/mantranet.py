...
class AnomalyDetector(nn.Module):
    ...
    def __init__(self, eps=10 ** (-6),device=device,with_GRU=False):
        ...
        self.end = nn.Sequential(nn.Conv2d(8, 2, 7, 1, padding=3),nn.Sigmoid()) #2 is number of classes
...
def pre_trained_model(weight_path='model/MantraNetv4.pt',device=device):
